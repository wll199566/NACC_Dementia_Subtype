...
def ctg_cont_wrong_prob(file_obj, whole_csv, col, label, ctg_bins_list, missing_values_list, is_ctg=True):
    ...
    if is_ctg:
        for i in range(len(ctg_bins_list)):
            ...
            sample_with_wrong_diag_in_this_bin = samples_in_this_bin.loc[samples_in_this_bin["pred_label"]!=samples_in_this_bin["label"]]
            ...
            if total_num_samples_in_this_bin == 0:
                ...
                if num_wrong_diag_in_this_bin != 0:
                    class_transition_wrong_samples([ctg_bins_list[i]], sample_with_wrong_diag_in_this_bin, "pred_label", file_obj)
    ...
    ### continuous feature ###
        ...
        for i in range(len(ctg_bins_list)-1):
            ...
            if total_num_samples_in_this_bin == 0:
                ...
                if num_wrong_diag_in_this_bin != 0:
                    class_transition_wrong_samples([bin_lower_bound, bin_upper_bound], sample_with_wrong_diag_in_this_bin, "pred_label", file_obj)
